package com.sean.user_service.util
...
class AuthUtil(
    ...
    fun genAccessToken(username: String?, issuer: String, roles: List<String>?,
                       user: com.sean.user_service.entity.User?): String {
//        val mapp: Map<String, Any?>? = user?.asMap()
    ...
    private fun makeObjMap(user: com.sean.user_service.entity.User?): Map<String, Any?>? {
        user?.apply {
            addresses == null
            roles == null
        }
